<section class="siteNav">
	<ul>
		<li><a href="<?php echo site_url(); ?>" class="dashboard">Dashboard</a></li>
		<li><a href="<?php echo site_url('map'); ?>" class="map">Map</a></li>
		<li><a href="<?php echo site_url('clan'); ?>" class="myClan">My Clan</a></li>
	</ul>
	<p class="twitter">
